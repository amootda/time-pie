    ...
    <div className="flex flex-col gap-3">
      ...
      >
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 3C6.48 3 2 6.48 2 10.5c0 2.49 1.53 4.68 3.87 5.97-.17.6-.67 2.16-.77 2.5-.12.42.15.42.32.31.13-.09 2.09-1.41 2.93-1.98.53.08 1.08.12 1.65.12 5.52 0 10-3.48 10-7.92S17.52 3 12 3z"/>
        </svg>
        카카오로 시작하기
      </button>
      <button
